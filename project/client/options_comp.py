...
class Ui_Form(object):
    def setupUi(self, form, ip, sock, obj):
        ...
        :param ip: ip of the computer that the manager connects to
        :param sock: socket object
        :param obj: encryption object
        """
        self.obj = obj
        self.sock = sock
        self.form = form
        ...
        self.pushButton.setIcon(QtGui.QIcon('scan_icon.png'))
        ...
        self.pushButton_2.setIcon(QtGui.QIcon('quarantine_folder_icon.png'))
        self.pushButton_2.setIconSize(QtCore.QSize(50, 50))
        layout2 = QtWidgets.QVBoxLayout(self.form)
        ...
        self.pushButton_3.setIcon(QtGui.QIcon('process_icon.png'))
    ...
    def show_quarantine_folder(self):
        """
        starts the quarantine management process
        """
...
class ScanWin(QtWidgets.QWidget):
    def start_ui(self, widget, sock, obj, content, is_quarantine):
        """
        Starts the main UI for the scan
        :param widget: widget object containing the windows
        :param sock: socket object
        :param obj: encryption object
        :param content: content to display to the client
        :param is_quarantine: True - shows quarantine window. False - shows scan window
        :return:
        """
        ...
        if is_quarantine:
            ...
            self.scan_button.clicked.connect(lambda: self.delete_file())
            self.select_button.clicked.connect(lambda: self.restore_file())
        else:
    ...
    def select_folder(self):
        """
        called when the manager selects a file to view it's content
        """
    ...
    def new_content_win(self, content):
        """
        shows the window again with the new content
        :param content: file names
        """
        self.scan_win = ScanWin()
    ...
    def scan_folder(self):
        """
        called when the manager starts the scan. opens a new window
        """
    ...
    def restore_file(self):
        """
        sends the server to restore the specified file
        """
        if not self.current_content:
            return
        ...
        msg.setInformativeText("File information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"The following file has been restored: {self.current_content}")
        msg.exec_()
    ...
    def delete_file(self):
        """
        sends the server to delete the specified file
        """
        if not self.current_content:
            return
        ...
        msg.setInformativeText("File information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"The following file has been deleted: {self.current_content}")
        msg.exec_()
    ...
    def delete_all_files(self):
        """
        deletes all files in the quarantine
        """
        msg = "DELETE_ALL"
        msg_encrypted = self.obj.encryption(msg)
        protocol.send_data(self.sock, msg_encrypted)
        ...
        msg.setIcon(QtWidgets.QMessageBox.Information)
        msg.setText("Operation completed successfully")
        msg.setInformativeText("Files information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"The following files have been deleted: {"\n".join(self.content)}")
        msg.exec_()
    ...
    def restore_all_files(self):
        """
        restores all files in the quarantine folder
        :return:
        """
        msg = "RESTORE_ALL"
        msg_encrypted = self.obj.encryption(msg)
        ...
        msg.setInformativeText("Files information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"The following files have been restored: {"\n".join(self.content)}")
        msg.exec_()
    ...
    def draw_box(self, font, i):
        ...
        :param i: index of file in files list
        """
        ...
        self.formlayout.addRow(self.button_list[i], self.label_list[i])
...
class loading_win(QtWidgets.QWidget):
    def start_ui(self, widget, sock, obj, content):
        """
        starts the UI for the file scan
        :param widget: widget object containing the screens
        :param sock: socket object
        :param obj: encryption object
    ...
    def file_select(self, i):
        """
        called when the manager selects a file
        :param i: index of file in content list
        """
        self.widget.removeWidget(self)
        self.close()
        self.widget.removeWidget(self)
...
class File_options(QtWidgets.QWidget):
    def start_ui(self, widget, socket, obj, file):
        """
        starts the UI for the file selection
        :param widget: widget object containing the screens
    ...
    def delete_file(self):
        ...
        msg.setInformativeText("File information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"File {self.file_name} Has been closed")
        msg.exec_()
    ...
    def quarantine_file(self):
        ...
        msg.setInformativeText("File information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"File {self.file_name} Has been quarantined")
        msg.exec_()
...
class ProcessWin(QtWidgets.QWidget):
    ...
    def draw_box(self, font, i):
        """
        draws a process to the manager's screen
        :param font: font object
        :param i: index of process in proc_dict
        """
        print(list(self.proc_dict.values())[i])
        self.label_list.append(QtWidgets.QLabel(f"Process name:: {str(list(self.proc_dict.values())[i])}"))
        self.button_list.append(QtWidgets.QPushButton(f"PID: {list(self.proc_dict.keys())[i]}"))
        self.label_list[i].setFont(font)
        self.button_list[i].setFont(font)
    ...
    def clicked_proc(self, index):
        """
        called when the manager clicks a process
        :param index: index of the process in proc_dict
        :return:
        """
        self.widget.removeWidget(self)
        self.close()
        self.proc_opt = ProcessOptions()
        self.proc_opt.start_ui(self.widget, int(list(self.proc_dict.keys())[index]),
                               list(self.proc_dict.values())[index], self.sock, self.obj)
...
class ProcessOptions(QtWidgets.QWidget):
    def start_ui(self, widget, pid, pname, socket, obj):
        """
        starts the UI for the process options
        :param widget: widget object containing the windows
        ...
        self.close_proc_button = QtWidgets.QPushButton(self)
        self.close_proc_button.setGeometry(425, 330, 200, 50)
        self.close_proc_button.setText("Kill process")
    ...
    def reduce_privs(self):
        """
        reduces the selected process privileges
        """
        ...
        msg.setIcon(QtWidgets.QMessageBox.Information)
        msg.setText("Operation completed successfully")
        msg.setInformativeText("Process information")
        msg.setWindowTitle("Operation status")
        msg.setDetailedText(f"Process: {self.pname} \nid: {self.pid} \nPrivileges have been reduced")
        msg.exec_()
