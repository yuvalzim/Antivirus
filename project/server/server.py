...
import project.hash_api as hash_api
from project import protocol
from project.encrypt import *
...
class ClientSession(threading.Thread):
    def __init__(self, client_socket):
        """
        initialises the ClientSession object
    ...
    def run(self):
        """
        runs a separate thread waiting for the client's requests
        :return:
        """
        # send public key
    ...
    def send_ack(self):
        """
        sends acknowledgement to the manager
        """
        self.client_socket.send("ack".encode())

    def handle_process_check(self):
        """
        handles the process check request. sends the client the requested data
        """
    ...
    def close_proc(self):
        """
        handles the close process request. Closes the specified process.
        """
        pid = int(self.arg)
    ...
    def reduce_privs(self):
        """
        handles the reduce privileges request. reduces the specified process's privileges
        """
        pid = int(self.arg)
    ...
    def initiate_scan(self):
        """
        handle the initiate scan request. send the client the disc names
        """
        self.current_path = ""
    ...
    def choose_dir(self):
        """
        handles the choose directory request. gets the content of the specified directory and sends it to the client.
        """
        dir_name = self.arg
    ...
    def scan_dir(self):
        """
        starts to scan the specified content.
        """
    ...
    def get_quarantined_files(self):
        """
        gets the quarantine folder contents
        """
    ...
    def delete_all_files(self):
        """
        deletes all the file in the quarantine folder
        """
    ...
    def restore_all_files(self):
        """
        restore all files in the quarantined folder.
        """
        path = os.path.dirname(__file__)
        full_path = os.path.join(path, QUARANTINE_PATH)
